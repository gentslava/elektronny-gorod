...
Добавьте в Home Assistant свои **домофоны, камеры и замки**: смотрите видео и
слушайте звук, открывайте двери, принимайте вызовы, разговаривайте с гостем и
просматривайте историю принятых и пропущенных звонков.

> ✨ **Готовится 4.0.0:** полноценный экран вызова, SIP-приём и двусторонний
> звук, FCM-события и карточка истории. Краткий обзор —
> [ниже](#что-нового-в-400), полный список — в
...
- **События для автоматизаций:** новые принятые и пропущенные вызовы, а также
  доступные события движения камер появляются как HA `event` entities.
