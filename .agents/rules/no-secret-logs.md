...
Реализован в `custom_components/elektronny_gorod/_logging.py`; контракт зафиксирован в `docs/decisions/0004-token-redaction.md`.
