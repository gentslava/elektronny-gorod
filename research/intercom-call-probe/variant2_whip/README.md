# Variant #2: WHIP-pull (scaffolding, НЕ ПРОВЕРЕНО LIVE)

> **ЭКСПЕРИМЕНТ** — scaffolding для сравнения с выбранным вариантом #1 (WS-binary).
> Нельзя тестировать без: (1) доступа к go2rtc с существующим стримом, (2) живого вызова
> из домофона. Не деплоить, не трогать продакшн-go2rtc без явного решения.
