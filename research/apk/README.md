...
| **Умный Дом.ру** | `com.ertelecom.smarthome` | `myhome.proptech.ru` + `id.dom.ru` | ⚠️ reference flavour; Keycloak auth не реализован |
...
├── 9.9.0-analysis.md                          ← статический + HAR/PCAP diff
├── myhome-9.9.0-original.apks                 ← Мой Дом, полный split bundle
├── myhome-9.9.0-original-patched.apks         ← после apk-mitm
├── myhome-9.7.0-original.apks                 ← baseline для diff
├── myhome-9.7.0-original-patched.apks
...
├── umnydom-9.9.0-original.apk                 ← Умный Дом.ру, current
├── umnydom-9.3.0-original.apk                 ← baseline для diff
