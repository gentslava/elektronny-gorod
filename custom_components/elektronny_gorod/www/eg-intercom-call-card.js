    ...
    `}_renderStatus(t,i){let s=t.showTimer&&this._config.timer!=="off",n=t.showAnswerWindow?this._answerWindow():null;return l`
      <div class="statusrow">
        <div class="strow">
          ...
          ${n?l`<span class="countdown"><eg-icon name="timer"></eg-icon>${n.text}</span>`:s?l`<span class="timer">${this._timerText()}</span>`:c}
        </div>
        ${n?l`<div class="window"><div class="fill" style="width:${n.fraction*100}%"></div></div>`:c}
      </div>
