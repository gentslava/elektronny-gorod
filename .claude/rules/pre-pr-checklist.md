...
`HISTORY_CLEAN` проверяет Git Historian через [Claude](../agents/git-historian.md) или [Codex](../../.codex/agents/git-historian.toml); если отдельная роль недоступна — Validator/root. Требования — в [`.claude/rules/git-history.md`](git-history.md):
