...
Last reviewed: 2026-08-11 (bounded per-entry FCM recovery and 616-test backend
...
| Реальные тесты | ✅ 616 backend + 62 frontend тестов зелёные локально; TypeScript check и production build зелёные |
