...
Last reviewed: 2026-08-11 (bounded per-entry FCM recovery and 580-test backend
...
| Реальные тесты | ✅ 580 backend + 62 frontend тестов зелёные локально; TypeScript check и production build зелёные |
