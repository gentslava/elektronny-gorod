...
| `custom_components/elektronny_gorod/manifest.json` | requirements: `audioop-lts` (нужен для `sip/audio.py`; `voip-utils` добавим в Slice 0-lifecycle после спайка — YAGNI) | модифицируется (Task 2) |
