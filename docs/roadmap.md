...
- [x] **A-58 history remainder** ✅ Реализовано в `feat/durable-event-history`: page-0 silent baseline, bounded ID dedup across restart и отдельный unload-safe poll lifecycle.
...
- [x] **A-50** ✅ Camera motion event-stream реализован в
  `feat/durable-event-history`; archive playback остаётся Slice 2.
